...
var getSecret_1 = require("../getSecret");
...
loginRouter.post("/", function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, passwordCorrect, _b, passwordHash, userForToken, token, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 4:
                ...
                passwordHash = user.passwordHash, userForToken = __rest(user, ["passwordHash"]);
                token = jsonwebtoken_1.default.sign(userForToken, (0, getSecret_1.getSecret)(), {
                    expiresIn: 60 * 60,
                });
            ...
            case 5:
                err_1 = _c.sent();
                console.error(err_1);
                response.status(400).send({ err: err_1 });
                return [3 /*break*/, 6];
