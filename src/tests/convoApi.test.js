...
test("Checking convo POST endpoint", function () { return __awaiter(void 0, void 0, void 0, function () {
    var postMessage, convoId, users, userFromId, userToId, secondPostMessage, conversation;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, api
                        .put("/api/conversation/".concat(convoId))
                        .expect(200)
                        .send({
                        userFromId: userToId,
                        title: "Sound's good",
            ...
            case 3:
                ...
                return [4 /*yield*/, api
                        .get("/api/conversation/".concat(convoId))
                        .expect(200)
                        .then(function (res) {
            ...
            case 4:
                _a.sent();
                return [4 /*yield*/, prisma_1.default.conversation.delete({ where: { id: convoId } })];
            case 5:
                _a.sent();
                return [2 /*return*/];
        }
